function initPickerMap() {
    pickerMap = new google.maps.Map(document.getElementById("ui_picker_map_wrap"), {
        ...
        zoom: 15
    }), pickerMarker = new google.maps.Marker({map: pickerMap, position: {lat: 0, lng: 0}})
}
...
"undefined" != typeof google && initPickerMap(), "undefined" != typeof jQuery.ui && ($(".ui-picker-draggable-handler").draggable({
    ...
    addClasses: !1,
    drop: function (a, b) {
        $("body").snackbar({content: 'Dropped on "' + $(this).html() + '"'})
    },
    ...
    ok: "Close",
    onClose: function () {
        $("body").snackbar({content: "Datepicker closes"})
    },
    onOpen: function () {
        $("body").snackbar({content: "Datepicker opens"})
    },
    selectMonths: !0,
    selectYears: 10,
    today: ""
    ...
    disable: [{
        from: [2016, 0, 10],
        to: [2016, 0, 30]
    }, [2016, 0, 13, "inverted"], {from: [2016, 0, 19], to: [2016, 0, 21], inverted: !0}], today: ""
...
$("#ui_snackbar_toggle_1").on("click", function () {
    $("body").snackbar({
        content: "Simple snackbar " + snackbarText + " with some text", show: function () {
            snackbarText++
        }
    })
